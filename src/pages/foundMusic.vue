...
<div class="foundMusic">
  <div class="header">
    ...
    <div class="topBar">
      <router-link v-for="(list,index) in topBar" key="index" exact :to="list.link" activeClass="select">{{list.name}}</router-link>
    </div>
  </div>
  <div class="content">
  ...
  data() {
    return {
      topBar: [{
        ...
        name: '主播电台',
        link: '/foundMusic/radioStation'
      }, {
        name: '排行榜',
        link: '/foundMusic/charts'
      }]
    }
  },
  components: {
